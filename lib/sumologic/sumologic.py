...
class SumoLogic(object):
    ...
    def start_report(self, action_type='DirectDownloadReportAction', export_format='Png', timezone='America/New_York', template='DashboardTemplate', dashid='RL1KB3twP5goDs6VjJwMruDRYyOyusTG0nbLYqt9LrxHnwTrkABwNHwT8rNk'):
        content = {
            "action": {
        ...
        #params = {'action': action_type, 'exportFormat': export_format, 'timezone': timezone, 'template': template}
